...
add_action('wp_enqueue_scripts', function () {
     ...
     */
    if (has_block('acf/clients-carousel')) {
        wp_enqueue_style('acf/clients-carousel.css', asset_path('styles/acf-clients-carousel.css'), false, null);
        wp_enqueue_script(
            'acf/clients-carousel.js',
            asset_path('scripts/acf-clients-carousel.js'),
            ['jquery', 'sage/main.js'],
            null,
            true
        );
...
add_action('after_setup_theme', function () {
    ...
    /**
     * Regaiter custom colors in block Color Palettes
     * @link https://developer.wordpress.org/block-editor/developers/themes/theme-support/#wide-alignment
     */
