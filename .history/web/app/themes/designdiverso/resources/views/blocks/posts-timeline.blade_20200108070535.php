...
(function($) {
  ...
  $(function(){
    ...
    $(document).on("click", function(event){
        if(!$(event.target).closest(".dd-posts-timeline__filter__list").length){
            $(".dd-posts-timeline__filter__list ul").fadeOut("fast");
        }
    });
    ...
    $('.dd-posts-timeline__filter__list__item__link, .dd-posts-timeline__filter__list__everything-link').click(function(){
      $(this).toggleClass('dd-posts-timeline__filter__list__item__link--active');
