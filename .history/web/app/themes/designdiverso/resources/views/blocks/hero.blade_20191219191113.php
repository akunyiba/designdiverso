...
<section data-{{ $block['id'] }} class="dd-hero xxl:px-20 {{ $block['classes'] }}">
  <div class="dd-hero__inner flex bg-cover px-10 items-center md:px-20">
    <div class="dd-hero__content">
        <h1 class="font-grotesk font-medium text-white text-h1 md:text-h1-md leading-none md:leading-tight tracking-tight">{!! $heading !!}</h1>
        <p class="mt-10 text-white hidden md:block">{!! $text !!}</p>
        <button class="btn btn--primary mt-6 md:mt-0 px-10 py-4 md:px-16 md:py-4">
