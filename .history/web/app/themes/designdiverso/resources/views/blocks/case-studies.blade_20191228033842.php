...
(function($) {
  ...
  $(function(){
    $('.dd-case-studies__filter__link').click(function(){
      ...
      $('.dd-case-studies__items__item').filter('.'+value).removeClass('dd-case-studies__items__item--margin').show('3000').is(":odd").addClass('dd-case-studies__items__item--margin');
      // caseStudiesAddMargin();
    });
  });
})(jQuery);
