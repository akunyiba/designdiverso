...
<section data-{{ $block['id'] }} class="dd-hero px-10 md:px-20 {{ $block['classes'] }}">
  <div class="dd-hero__inner flex bg-cover px-20 items-center">
    <div class="dd-hero__content">
        <h1 class="font-grotesk font-medium text-white text-h1 tracking-tight">{!! $heading !!}</h1>
        <p class="mt-10 text-white">{!! $text !!}</p>
        <button class="btn btn--primary btn--p-big">
