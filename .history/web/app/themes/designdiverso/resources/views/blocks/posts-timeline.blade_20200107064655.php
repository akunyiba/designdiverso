...
@foreach ($filter_categories as $category )
   <a
   class="dd-posts-timeline__filter__link {{ !$loop->first ? 'dd-posts-timeline__filter__link--separator' : '' }}"
   href="javascript:;"
...
@endforeach
@endif
  <div class="dd-posts-timeline__items__item dd-posts-timeline__items__item--visible {{ $categories }}">]
    <pre>@php print_r($categories); @endphp</pre>
    <h3>{{ $title }}</h3>
