...
<div class="dd-posts-timeline__filter">
  ...
  <div class="dd-posts-timeline__filter-menu">
    <a class="dd-posts-timeline__filter-menu-link dd-posts-timeline__filter-menu-link--everything" data-filter="everything" href="javascript:;">{{ __( 'everything', 'sage' ) }}</a>
    <ul class="hidden">
...
(function($) {
  ...
  $(function(){
    ...
    $('.dd-posts-timeline__filter-menu-link').click(function(){
      $('.dd-posts-timeline__filter-menu-link').toggleClass('dd-posts-timeline__filter-menu-link--active');
      $(this).toggleClass('dd-posts-timeline__filter-menu-link--active');
    });
  });
})(jQuery);
</script>
