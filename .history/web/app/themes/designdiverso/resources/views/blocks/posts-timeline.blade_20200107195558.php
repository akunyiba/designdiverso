...
<div class="dd-posts-timeline__filter">
  <div class="dd-posts-timeline__filter__text">
      {{ __('I  want  to  learn  about ', 'sage') }} <a data-filter="everything" href="javascript:;">{{ __( 'everything', 'sage' ) }}</a>
  </div>
  <ul class="dd-posts-timeline__filter__list">
    @foreach ($filter_categories as $category )
      <li><a href="javascript:;" data-filter="{{$category->slug}}">{{ $category->name }}</a></li>
    @endforeach
  </ul>
</div>
@endif
...
(function($) {
  ...
  $(function(){
    $('.dd-posts-timeline__filter__select').change(function(){
      var value = $(this).val();
