...
<div class="dd-posts-timeline__filter">
  ...
  <div class="dd-posts-timeline__filter__list">
    <a class="dd-posts-timeline__filter__list__item__link dd-posts-timeline__filter__list__item__link--everything" data-filter="everything" href="javascript:;">{{ __( 'everything', 'sage' ) }}</a>
    <ul>
...
(function($) {
  ...
  $(function(){
    $('.dd-posts-timeline__filter__list__item__link').click(function(){
